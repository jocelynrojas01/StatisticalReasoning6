...
-   Values of response variables: count data - non-negative integers (can't have a negative number of flowers), could include zeros (there may not be any flowers)

-   Distribution: Poisson distribution or negative binomial distribution

2.  Whether or not a female elephant seal gives birth

-   Values of response variables: 0s and 1s (1 for yes: birth or 0 for no: did not give birth)
...
-   Values of response variables: non-negtive integers, fractions
-   Distribution: Gamma distribution
...
This data does not appear to be normally distributed. The data seems to be right-skewed with outliers far to the right in the graph.
...
- Randome: state of residence, school district
